...
// Le sole size di WordPress che restano sono thumbnail (griglia dell'admin) e medium: tutto il resto passa dai resize di Timber sulle larghezze canoniche di avif.php, quindi le size intermedie sarebbero solo file in più a ogni upload.
// Anche 1536x1536 e 2048x2048 si tolgono di qui: un remove_image_size() su init sarebbe un secondo posto che dice la stessa cosa.
// La qualità JPEG la governa Timber AVIF (impostazione jpeg_quality, default 95): un filtro qui la sovrascriverebbe a seconda dell'ordine di registrazione.
